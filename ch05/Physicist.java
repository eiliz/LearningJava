...
public class Physicist implements GamePiece {
    ...
    // Some helpers for optimizing the draw() methods that can be called many
    // times
    int x, y;

    // Boundary helpers
    private final int physicistHeight =
            (int) (1.5 * Field.PHYSICIST_SIZE_IN_PIXELS);
    ...
    public void setPosition(int x, int y) {
        ...
        this.x = x - offset;
        this.y = y - offset;
        boundingBox = new Rectangle(this.x, this.y,
